...
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>data = [[1, 20300104, 100, 80], [2, 20300804, 847, 37], [3, 20300401, 10, 8]]
...
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>data = [[3,20300401,10,8],[1,20300104,100,80]]
</code><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre></div>
